...
const options = ref({
  ...
  messageToDelete: '¿Estás seguro que deseas eliminar el módulo: {{name}}?'
})
...
function clearForm() {
  ...
  idItem.value = ''
  updateFieldProperty(fields, 'name', 'disabled', false)
  ...
  if (id) {
    ...
    try {
      ...
      if (response) {
        ...
        updateFieldProperty(fields, 'name', 'disabled', true)
      }
...
<template>
  <div class="flex justify-content-between align-items-center">
    ...
    <IfCan :perms="['ADMINISTRACION:GESTION-MODULOS']">
      ...
      <div class="bg-white">
        ...
        <div class="card">
          <EditFormV3
            ...
            :permission-save="idItem ? ['ADMINISTRACION:GESTION-MODULOS'] : ['ADMINISTRACION:GESTION-MODULOS']"
            :hide-delete-button="true"
            :show-cancel-button="true"
            :permission-delete="['ADMINISTRACION:GESTION-MODULOS']"
            @cancel="clearForm"
