...
import { convertDates, convertOneDate, filterDatesByMonth, validEmail } from '../utils/valid_form_fields'
import { GenericService } from '../services/generic-services'
import type { OptionField } from './interfaces/IFieldInterfaces'
...
const props = defineProps({
  properties: {
    type: Object as PropType<OptionField>,
    required: true,
  },
  validationKeywords: {
